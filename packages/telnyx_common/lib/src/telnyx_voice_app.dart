...
class TelnyxVoiceApp extends StatefulWidget {
  ...
  static Future<void> handleBackgroundPush(RemoteMessage message) async {
    ...
    try {
      ...
      TelnyxClient.setPushMetaData(message.data, isAnswer: false, isDecline: false);
...
class _TelnyxVoiceAppState extends State<TelnyxVoiceApp> with WidgetsBindingObserver {
  ...
  telnyx_state.ConnectionState _currentConnectionState = const telnyx_state.Disconnected();
  StreamSubscription<telnyx_state.ConnectionState>? _connectionStateSubscription;
