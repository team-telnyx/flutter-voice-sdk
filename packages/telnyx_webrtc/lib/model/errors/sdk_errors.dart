/// Error definition entry for the SDK error registry.
...
/// SDK error code registry — 24 entries.
///
/// Ported 1:1 from JS SDK `constants/errors.ts`.
const Map<int, TelnyxErrorDefinition> sdkErrors = {
  // ── SDP errors (400xx) ──────────────────────────────────────────────
  40001: TelnyxErrorDefinition(
