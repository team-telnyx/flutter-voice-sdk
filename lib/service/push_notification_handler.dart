...
class WebPushNotificationHandler implements PushNotificationHandler {
  ...
  Future<void> initialize() async {
    if (kDebugMode) {
      _logger.i(
        '[PushNotificationHandler-Web] Initialize: No push notification setup for web.',
      );
    }
  }
  ...
  Future<void> processIncomingCallAction(
    ...
    if (kDebugMode) {
      _logger.i(
        '[PushNotificationHandler-Web] processIncomingCallAction: Not applicable for web. Payload: $payload, Answer: $isAnswer, Decline: $isDecline',
      );
    }
  }
  ...
  Future<void> displayIncomingCallUi(Map<dynamic, dynamic> payload) async {
    if (kDebugMode) {
      _logger.i(
        '[PushNotificationHandler-Web] displayIncomingCallUi: Not applicable for web. Payload: $payload',
      );
    }
  }
  ...
  Future<String?> getPushToken() async {
    if (kDebugMode) {
      _logger.i(
        '[PushNotificationHandler-Web] getPushToken: Not applicable for web.',
      );
    }
    return null;
  }
  ...
  Future<Map<String, dynamic>?> getInitialPushData() async {
    if (kDebugMode) {
      _logger.i(
        '[PushNotificationHandler-Web] getInitialPushData: Not applicable for web.',
      );
    }
    return null;
  }
  ...
  Future<void> showMissedCallNotification(Map<dynamic, dynamic> payload) async {
    if (kDebugMode) {
      _logger.i(
        '[PushNotificationHandler-Web] showMissedCallNotification: Not applicable for web. Payload $payload',
      );
    }
  }
  ...
  void clearPushData() {
    if (kDebugMode) {
      _logger.i(
        '[PushNotificationHandler-Web] clearPushData: Not applicable for web.',
      );
    }
  }
  ...
  bool isFirebaseInitialized() {
    ...
    if (kDebugMode) {
      _logger.i(
        '[PushNotificationHandler-Web] isFirebaseInitialized: Returning false (web has specific init if used).',
      );
    }
    return false;
  }
